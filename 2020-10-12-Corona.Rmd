...
dataCovActive$Germany <- (as.integer(dataCovConfirmed$Germany)- as.integer(dataCovRecovered$Germany))
...
Non-cumulative, active cases were calculated as the difference between the cumulative active and the cumulative recovered curves.
